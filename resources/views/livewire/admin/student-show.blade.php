        ...
        <div class="flex gap-2">
            <div class="dropdown dropdown-end">
                <button tabindex="0" class="btn btn-primary btn-sm">
                    ...
                    {{ __("Certificate") }}
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3"><path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" /></svg>
                </button>
                <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                    <li><a wire:click="downloadAttestation('fr')">{{ __("Certificate") }} (Français)</a></li>
                    <li><a wire:click="downloadAttestation('ar')">{{ __("Certificate") }} (العربية)</a></li>
                </ul>
            </div>
        </div>
    </div>
