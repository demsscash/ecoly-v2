<div>
    ...
    <div class="mb-6">
        ...
        <p class="text-base-content/60">{{ __('Dashboard') }} - Ecoly</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="stat bg-base-100 rounded-box shadow">
            ...
            <div class="stat-desc">{{ __('Active') }}</div>
        </div>
        ...
        <div class="stat bg-base-100 rounded-box shadow">
            ...
            <div class="stat-title">{{ __('Finances') }}</div>
    ...
    <div class="card bg-base-100 shadow">
        <div class="card-body">
            <h2 class="card-title">{{ __('Welcome') }} à Ecoly !</h2>
            <p>Système de gestion scolaire pour l'école Aboubacar Fall.</p>
